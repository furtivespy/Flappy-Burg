...
var Share = me.GUI_Object.extend({
    ...
    onClick: function(event) {
        var shareText = 'Just made ' + game.data.steps + ' forks in Flappy Burg! Can you beat me? Try online here!';
        var url = 'https://ginadamico.wordpress.com/2015/01/06/the-hellhole-has-opened/';
        FB.ui(
            {
             method: 'feed',
             name: 'My Flappy Burg Score!',
             caption: "Share to your friends",
             description: (
                    shareText
             ),
             link: url,
             picture: 'http://furtivespy.github.io/Flappy-Burg/data/img/clumsy.png'
            }
        );
        return false;
    }
...
var Tweet = me.GUI_Object.extend({
    ...
    onClick: function(event) {
        var shareText = 'Just made ' + game.data.steps + ' forks on Flappy Burg! Can you beat me? Try online here!';
        var url = 'https://ginadamico.wordpress.com/2015/01/06/the-hellhole-has-opened/';
